...
{
    @PostMapping("/insert")
    public ResponseEntity<Object> insert(@RequestBody PointDeVente pv)
    {
        ...
        try
        {
            fonction.insertPointDeVente(pv);
    ...
    public ResponseEntity<Object> delete(@PathVariable int id)
    {
        ...
        try
        {
            fonction.deletePointDeVente(id);
            status=HttpStatus.OK;
            response.put("msg","succes");
        }
        catch(Exception e)
    ...
    public ResponseEntity<Object> getAll()
    {
        ...
        try
        {
            ...
            status=HttpStatus.OK;
            response.put("msg","succes");
            response.put("lieux",fonction.getAllLieu());
            response.put("pv",pv);
        }
        catch(Exception e)
        {
